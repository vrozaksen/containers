...
| `ghcr.io/vrozaksen/sonarr:4.0.13.2932`                | ❌         |
| `ghcr.io/vrozaksen/sonarr:rolling@sha256:8053...`    | ✅         |
| `ghcr.io/vrozaksen/sonarr:4.0.13.2932@sha256:8053...` | ✅         |
...
services:
  sonarr:
    image: ghcr.io/vrozaksen/sonarr:4.0.13.2932
...
A lot of inspiration and ideas are thanks to the hard work of the home-ops community, [onedr0p](https://github.com/onedr0p), [joryirving](https://github.com/joryirving), [hotio.dev](https://hotio.dev/) and [linuxserver.io](https://www.linuxserver.io/) contributors.
